...
TMP_DIR = '/tmp/ibmds/'
CRED = {
        'IBM.2107-75CAY20': {'User': 'zabbix',
        'Password': 'm0nitorADM!',
        'hmc1': '10.45.109.158',
        'hmc2': '10.45.109.158',
        'scriptfile': '/usr/local/share/zabbix/externalscripts/ibmds_scripts/IBM.2107-75CAY20.txt',
        'dir': 'IBM.2107-75CAY20',
        'devid': 'IBM.2107-75CAY21'
        }
        }
